 ...
 * 
 */
public class firstLevelReources extends ServerResource {
	...
	public void represent() {
		...
		_info.setStatus(_st);
		_det.getValue().add(ResourcePathURIs.VERSION);
		_det.getValue().add(ResourcePathURIs.RESET);
		_det.getValue().add(ResourcePathURIs.STARTUP);
		_det.getValue().add(Resources.NET_ROOT_URI);
